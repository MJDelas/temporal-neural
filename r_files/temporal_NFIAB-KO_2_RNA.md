...
![](temporal_NFIAB-KO_2_RNA_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
```
    ...
    ##  [1] UpSetR_1.4.0                tximport_1.31.1            
    ##  [3] ComplexHeatmap_2.19.0       lubridate_1.9.3            
    ...
    ## [34] tzdb_0.4.0              rjson_0.2.21            zlibbioc_1.49.3        
    ## [37] parallel_4.4.0          XVector_0.43.1          vctrs_0.6.5            
