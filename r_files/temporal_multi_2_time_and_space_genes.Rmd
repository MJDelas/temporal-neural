...
#subworkinput="inputs_glialmulti_2/"

#subworkinput2="outputs_glialmulti_3_figR_fromOnDemand/"
...
#outdir="outputs_glialmulti_3_figR_allelements_WTonly/"
...
```{r}
#cisCorr.filt <- cisCor_peakID %>% filter(pvalZ <= 0.05)
...
Using `cisCorr.filt` for pvalZ < 0.05

```{r}

# elements_ordered_manymatches <- genes_ordered %>% 
...
#             D9_p1="#1a91c1",D9_p2="#c19e1a",D9_pM="#c11a3d",
#             D11_p1="#0e506b",D11_p2="#6b570e",D11_pM="#7c1127"),
#   NFIAstatus = c(`NFIAn`="#f6f6f6",`NFIAp`="#595959"),
#   Day = c(D5="#fadede",D7="#f3aaaa",D9="#e96666",D11="#cf1e1e"),
#   Rep = c(R1="#ebeb77", R2="#77b1eb", R3="#eb7777"))
# 
# heatmap_ann <- HeatmapAnnotation(df=phen_data, 
#     col=ann_color_IZ, show_legend = FALSE,
...
# row_temp_annotation <- data.frame(intervalid=row.names(data)) %>%
#   mutate(t=case_when(intervalid %in% tempALL_elements$x ~ "temporal", TRUE ~ "not_temporal")) %>%
#   select("t")
# 
# ann_color_row_JD <- list(
#   t = c(temporal="#5a5a5a",not_temporal="white"))
# 
# rowAnn <- HeatmapAnnotation(
#     df = row_temp_annotation,
...
# 
# hmap_elem_sig_corr06 = draw(hmap_elem_sig_corr06,
#     heatmap_legend_side = 'left',
#     annotation_legend_side = 'left',
#     row_sub_title_side = 'right')
# 
# # print heatmap
# pdf(paste0(workingdir,outdir,"Heatmap_elements_pval005_r06_.pdf"), width = 4.5, height = 4) 
# 
# draw(hmap_elem_sig_corr06,
#     heatmap_legend_side = 'left',
#     annotation_legend_side = 'left',
#     row_sub_title_side = 'right')
# 
