...
The function plots all pairwise technical replicates for both screen 1 and 2 (biological replicates)
...
Orange line shows threshold for Screen 2. Using NFIA as a guide for what is an expected depletion in object coutns.
...
Hits that will fall below the object count threshold for either Screen 1 or 2 have been labelled.
...
Continue with `nfia_intensities_bothreps_withwell` generated above, but add annotation of which ones are hits or validation set.
